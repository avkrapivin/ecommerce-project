...
export class CheckoutComponent implements OnInit {
    ...
    copyShippinAddressToBillingAddress(event: any) {
    ...
    onSubmit() {
        ...
        const shippingACountry: Country = JSON.parse(JSON.stringify(purchase.shippingAddress.country));
        purchase.shippingAddress.state = shippingState.name;
        purchase.shippingAddress.country = shippingACountry.name;
